...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAACAgUAAxkBAALi_WGwG7iPUFslTw2w12Ebu35RBAqkAAKQBAACHnBZVxxoyfKa7tcEIwQ')
            return
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='t.me/KOT_BOTS')
                ]
                ]
            ...
            buttons = [
                [
                    InlineKeyboardButton('Main Channel', url='t.me/KOT_LINKS_TEAM')
                ]
                ]
